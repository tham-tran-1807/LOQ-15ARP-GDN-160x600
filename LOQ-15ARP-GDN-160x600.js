...
lib.ssMetadata = [
		{name:"LOQ_15ARP_GDN_160x600_atlas_1", frames: [[1134,0,50,50],[0,0,160,600],[162,0,160,600],[324,0,160,600],[486,0,160,600],[648,0,160,600],[810,0,160,600],[972,0,160,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["LOQ_15ARP_GDN_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A2A2A2").s().p("EgMfAu4MAAAhdvIY/AAMAAABdvg");
...
// stage content:
(lib.LOQ15ARPGDN160x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(374).call(this.frame_374).wait(36));

	// nut_ao_replay
	this.btn_replay = new lib.nutreplay();
	this.btn_replay.name = "btn_replay";
	this.btn_replay.setTransform(11.55,11.8,1,1,0,0,0,9.8,9.8);
	this.btn_replay._off = true;
	new cjs.ButtonHelper(this.btn_replay, 0, 1, 2, false, new lib.nutreplay(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(373).to({_off:false},0).wait(37));

	// hinh_mui_ten
	this.mc_mui_ten_xoay = new lib.Chamuitenxoay();
	this.mc_mui_ten_xoay.name = "mc_mui_ten_xoay";
	this.mc_mui_ten_xoay.setTransform(10.6,-11,1,1,0,0,0,14.6,10.2);
	this.mc_mui_ten_xoay._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(360).to({_off:false},0).to({y:11},12).wait(38));

	// clickTag_btn
	this.clickTag_btn = new lib.clickTag_btn();
	this.clickTag_btn.name = "clickTag_btn";
	this.clickTag_btn.setTransform(80,300,1,1,0,0,0,80,300);
	new cjs.ButtonHelper(this.clickTag_btn, 0, 1, 2, false, new lib.clickTag_btn(), 3);

	this.timeline.addTween(cjs.Tween.get(this.clickTag_btn).wait(410));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(360).to({_off:false},0).wait(50));

	// Layer_6
	this.instance_1 = new lib.Frame6();
	this.instance_1.setTransform(0,1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({_off:true},60).wait(50));

	// Layer_5
	this.instance_2 = new lib.Frame5();
	this.instance_2.setTransform(0,1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(240).to({_off:false},0).to({_off:true},60).wait(110));

	// Layer_4
	this.instance_3 = new lib.Frame4();
	this.instance_3.setTransform(0,1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(181).to({_off:false},0).to({_off:true},59).wait(170));

	// Layer_3
	this.instance_4 = new lib.Frame3();
	this.instance_4.setTransform(0,1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(120).to({_off:false},0).to({_off:true},61).wait(229));

	// Layer_2
	this.instance_5 = new lib.Frame2();
	this.instance_5.setTransform(0,1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(60).to({_off:false},0).to({_off:true},60).wait(290));

	// Layer_1
	this.instance_6 = new lib.Frame1();
	this.instance_6.setTransform(0,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},60).wait(350));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(80,281.3,80,319.7);
// library properties:
lib.properties = {
	id: '75758439B859FE4486D3D0E634C7F587',
	width: 160,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/LOQ_15ARP_GDN_160x600_atlas_1.png", id:"LOQ_15ARP_GDN_160x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['75758439B859FE4486D3D0E634C7F587'] = {
